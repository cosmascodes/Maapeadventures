const AdventureStory = (props) => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center mt-8 ml-6 md:ml-0">
      ...
      <div className="font-mono uppercase md:pl-4 ">
        <h2 className="text-sm md:text-2xl mb-1 font-semibold text-primary w-40">
          {props.title}
        </h2>
