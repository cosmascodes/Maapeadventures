...
const Footer = () => {
  return (
    <div>
      ...
      <div className="bg-primary flex flex-col md:flex-row justify-center md:justify-between  items-center py-6 md:py-12 px-6 md:px-48 text-center">
        <div>
          <ul className="mb-2 flex flex-col md:flex-row text-secondary underline text-xl w-[320px] justify-between ">
            <li>
        ...
        <div className=" flex flex-row w-[120px] justify-center mt-5 md:mt-0">
          <Image src={"/images/home_page/u73.svg"} width={51} height={61} />
          <Image
            src={"/images/home_page/u74.svg"}
            width={51}
            height={61}
            className="mx-4"
          />
          <Image src={"/images/home_page/u72.svg"} width={51} height={61} />
        </div>
