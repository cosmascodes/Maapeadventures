  ...
  return (
    <div>
      <div className="bg-redTheme py-6 md:py-12 flex flex-col justify-center items-center">
        <p className="text-center text-white text-sm md:text-lg font-semibold lg:w-[30%] mb-4">
      ...
      <div className="bg-primary flex flex-col md:flex-row justify-between py-6 md:py-12 px-6 md:px-24">
        <div>
          <ul className="mb-2 flex flex-col md:flex-row text-secondary underline text-lg w-[320px] justify-between">
            <li>
